...
5. 读取本单元对应的 `knowledge/teaching-guides/.../*.teaching.md`，确定核心知识点、重要背景、了解即可、出题权限和本节不要求。
6. 按知识点指引指定的段落读取 `textbook/chapters/*.md` 教材原文。
7. 使用 `practice/task-generation-rules.md` 和 `practice/daily-diagnostics.md` 完成立即练习、反馈、补救和再测。
8. 根据学习表现更新或参考 `progress/`、`review/` 和 `logs/learning-sessions/`。
